...
def parser_arguments():
    ...
    parser.add_argument('--type_csv', required=False,
    ...
    parser.add_argument('--sub', required=False, choices=['h', 'm'],
                        metavar="Subset of human verified images or "
                                "machine generated (h or m)",
                        help='Download from the human verified dataset '
                             'or from the machine generated one.')
    parser.add_argument('--image_IsOccluded', required=False, choices=['0', '1'],
                        metavar="1 or 0",
                        help='Optional characteristic of the images. '
                             'Indicates that the object is occluded by '
                             'another object in the image.')
    parser.add_argument('--image_IsTruncated', required=False, choices=['0', '1'],
                        metavar="1 or 0",
                        help='Optional characteristic of the images. Indicates '
                             'that the object extends beyond the boundary of the image.')
    ...
    parser.add_argument('--multiclasses', required=False, default='0',
                        choices=['0', '1'],
